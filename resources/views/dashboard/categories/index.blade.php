    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <a href="{{ route('dashboard.categories.create') }}" class="btn-primary">Add Category</a>
                            ...
                            @foreach ($categories as $category)
                                <tr
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        {{ $categories->perPage() * ($categories->currentPage() - 1) + $loop->index + 1 }}
                                    </td>
                                    <th scope="row"
                                    ...
                                    <td class="flex items-center justify-center px-6 py-4 space-x-3">
                                        ...
                                        <a href="{{ route('dashboard.categories.destroy', $category->slug) }}"
