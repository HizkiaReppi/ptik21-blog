  ...
  <div class="mx-[3%] my-5">
    <div class="flex justify-between gap-5">
      <div class="w-full bg-white rounded-lg px-16 py-10">
        ...
        <div
          class="flex flex-wrap justify-between text-base font-medium text-gray-700 my-5"
        >
          <div class="flex flex-wrap justify-between lg:justify-normal">
            <a
              href="{{ route('dashboard.posts.index') }}"
              class="btn-green w-full lg:w-auto"
              >Back To Post Management</a
            >
            <a
              href="{{ route('dashboard.posts.edit', $post->slug) }}"
              class="btn-yellow w-[45%] lg:w-auto"
              >Edit</a
            >
            <a
              href="{{ route('dashboard.posts.destroy', $post->slug) }}"
              class="btn-red w-[45%] lg:w-auto"
