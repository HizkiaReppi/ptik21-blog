          ...
          <table class="w-full text-sm text-gray-500 dark:text-gray-400">
            ...
            <tbody>
              ...
              <tr
                ...
                <td class="px-6 py-4 text-center">{{ $posts->perPage() * ($posts->currentPage() - 1) + $loop->index + 1 }}</td>
                <th
                  scope="row"
                ...
                <td class="flex items-center justify-center px-6 py-4 space-x-3">
                  ...
                  <a
                    href="{{ route('dashboard.posts.destroy', $post->slug) }}"
              ...
              @if ($posts->count() < 1)
                <tr>
                  <td colspan="5" class="text-center py-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">Post Not Found</td>
                </tr>
              @endif
            </tbody>
          </table>
