    ...
    <div class="w-3/5">
      <form action="/">
        ...
        <div class="flex justify-center items-center gap-1">
          <x-text-input
            type="text"
            class="w-full md:w-1/2 py-2 px-3"
            placeholder="Search"
            name="search"
  ...
  <section class="mx-[6%] mt-5">
    <div class="flex justify-center items-center">
      ...
      >
        @if ($posts[0]->image)
        <img
          src="{{ asset('storage/post-image/' . $posts[0]->image) }}"
        ...
        <div class="flex flex-col justify-between p-4 w-full leading-normal">
          ...
          <h6
            class="mb-2 text-xs md:text-lg font-semibold tracking-tight text-gray-900 dark:text-white"
          >
      ...
      >
        ...
        <div class="p-5 flex flex-col justify-between">
          <div>
            ...
            <h6
              class="mb-2 text-xs font-bold tracking-tight text-gray-900 dark:text-white"
            >
