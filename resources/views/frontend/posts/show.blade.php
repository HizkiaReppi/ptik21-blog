    ...
    <div class="mx-[3%] my-5">
        <div class="flex flex-col-reverse lg:flex-row justify-between gap-5">
            <div class="h-full w-full lg:w-3/12 bg-white rounded-lg px-8 py-6">
                ...
                @foreach ($similarPosts as $similarPost)
                    <div
                        ...
                        <div class="flex flex-col w-full justify-between p-4 leading-normal">
                            ...
                            <h6 class="mb-2 text-xs font-semibold tracking-tight text-gray-900 dark:text-white">
                            ...
                            <div class="flex justify-between items-center">
                                <a href="/posts/{{ $similarPost->slug }}"
                                    ...
                                    Read more
                                    <svg aria-hidden="true" class="w-2 h-2 ml-2 -mr-1" fill="currentColor"
                ...
                <a href="/" class="inline lg:hidden text-decoration-none text-sm">Kembali ke Halaman Utama</a>
            </div>
